classdef Fitness
    ...
    methods (Access = public)
        ...
        function this = Fitness(config, sizes, structure, genes, active, inputs, functions)
            ...
            this.fitness_ = config.fitness_function(sizes, structure, genes, active, inputs, functions, config.run, config.generation);
